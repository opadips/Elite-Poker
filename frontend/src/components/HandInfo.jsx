...
export default function HandInfo({ holeCards, communityCards, round, playerName }) {
  ...
  return (
    <div className="fixed bottom-20 left-4 z-20 bg-black/70 backdrop-blur-md rounded-xl p-2 shadow-2xl border border-amber-700/50 w-56 text-white text-xs">
      <div className="text-amber-400 font-bold text-center border-b border-amber-700 pb-1 mb-1">📊 Hand</div>
      ...
      <div className="text-blue-300">{advice}</div>
    </div>
  );
}